...
namespace llvm {
  ...
  public:
    ...
    /// EmitFuncAlignment - Emit alignment for a function.
    ///
    /// @param ByteAlignment - The alignment to reach. This must be a power of
    /// two on some targets.
    /// @param MaxBytesToEmit - passed on to EmitCodeAlignment, if called.
    virtual void EmitFuncAlignment(unsigned ByteAlignment,
                                   unsigned MaxBytesToEmit = 0) = 0;
