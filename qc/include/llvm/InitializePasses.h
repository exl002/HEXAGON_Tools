...
void initializeGlobalOptNoSRAPass(PassRegistry&);
...
void initializePullUpLifetimeEndMarkersPass(PassRegistry&);
...
void initializeShrinkWrapCommonArgsPass(PassRegistry&);
...
void initializeDhrystoneLoopEliminatePass(PassRegistry&);
...
void initializeAggressiveTypePromotionPass(PassRegistry&);
void initializeSpecializeFunctionPointersPass(PassRegistry&);
void initializeReduceSwitchComparesPass(PassRegistry&);
void initializeDiffAndMergePass(PassRegistry&);
void initializeCollocateConstantsPass(PassRegistry&);
void initializeCFGSizeOptPass(PassRegistry&);
}
