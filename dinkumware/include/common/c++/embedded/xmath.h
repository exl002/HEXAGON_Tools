...
#define DSIGN(x)	(strict_aliasing_workaround((unsigned short *)(char *)&(x))[_D0] & _DSIGN)
...
#define FSIGN(x)	(strict_aliasing_workaround((unsigned short *)(char *)&(x))[_F0] & _FSIGN)
...
#define LSIGN(x)	(strict_aliasing_workaround((unsigned short *)(char *)&(x))[_L0] & _LSIGN)
