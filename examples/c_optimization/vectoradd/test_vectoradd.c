...
REGISTER_VecADD_VERSION(VecADD_unrolled);
REGISTER_VecADD_VERSION(VecADD_vectorized);
...
struct VecADD_version funcs[] =
  {
    ...
    VecADD_VERSION(VecADD_unrolled, "Unrolled code"),
    VecADD_VERSION(VecADD_vectorized, "Vectorized code")
  };
