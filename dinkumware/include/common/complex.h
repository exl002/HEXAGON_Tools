...
_C_LIB_DECL
double cimag(_Dcomplex) _NO_THROW;
double creal(_Dcomplex) _NO_THROW;
float cimagf(_Fcomplex) _NO_THROW;
float crealf(_Fcomplex) _NO_THROW;
long double cimagl(_Lcomplex) _NO_THROW;
long double creall(_Lcomplex) _NO_THROW;
_END_C_LIB_DECL
 ...
 #define I	_Complex_I
		...
		/* FUNCTIONS */
_C_LIB_DECL
double cabs(_Dcomplex) _NO_THROW;
_Dcomplex cacos(_Dcomplex) _NO_THROW;
_Dcomplex cacosh(_Dcomplex) _NO_THROW;
double carg(_Dcomplex) _NO_THROW;
_Dcomplex casin(_Dcomplex) _NO_THROW;
_Dcomplex casinh(_Dcomplex) _NO_THROW;
_Dcomplex catan(_Dcomplex) _NO_THROW;
_Dcomplex catanh(_Dcomplex) _NO_THROW;
_Dcomplex ccos(_Dcomplex) _NO_THROW;
_Dcomplex ccosh(_Dcomplex) _NO_THROW;
_Dcomplex cexp(_Dcomplex) _NO_THROW;
/* double cimag(_Dcomplex) _NO_THROW; */
/* _Dcomplex clog(_Dcomplex) _NO_THROW; */
_Dcomplex clog10(_Dcomplex) _NO_THROW;
_Dcomplex conj(_Dcomplex) _NO_THROW;
_Dcomplex cpow(_Dcomplex, _Dcomplex) _NO_THROW;
_Dcomplex cproj(_Dcomplex) _NO_THROW;
/* double creal(_Dcomplex) _NO_THROW; */
_Dcomplex csin(_Dcomplex) _NO_THROW;
_Dcomplex csinh(_Dcomplex) _NO_THROW;
_Dcomplex csqrt(_Dcomplex) _NO_THROW;
_Dcomplex ctan(_Dcomplex) _NO_THROW;
_Dcomplex ctanh(_Dcomplex) _NO_THROW;
double norm(_Dcomplex) _NO_THROW;	/* added with TR1 */

float cabsf(_Fcomplex) _NO_THROW;
_Fcomplex cacosf(_Fcomplex) _NO_THROW;
_Fcomplex cacoshf(_Fcomplex) _NO_THROW;
float cargf(_Fcomplex) _NO_THROW;
_Fcomplex casinf(_Fcomplex) _NO_THROW;
_Fcomplex casinhf(_Fcomplex) _NO_THROW;
_Fcomplex catanf(_Fcomplex) _NO_THROW;
_Fcomplex catanhf(_Fcomplex) _NO_THROW;
_Fcomplex ccosf(_Fcomplex) _NO_THROW;
_Fcomplex ccoshf(_Fcomplex) _NO_THROW;
_Fcomplex cexpf(_Fcomplex) _NO_THROW;
/* float cimagf(_Fcomplex) _NO_THROW; */
_Fcomplex clogf(_Fcomplex) _NO_THROW;
_Fcomplex clog10f(_Fcomplex) _NO_THROW;
_Fcomplex conjf(_Fcomplex) _NO_THROW;
_Fcomplex cpowf(_Fcomplex, _Fcomplex) _NO_THROW;
_Fcomplex cprojf(_Fcomplex) _NO_THROW;
/* float crealf(_Fcomplex) _NO_THROW; */
_Fcomplex csinf(_Fcomplex) _NO_THROW;
_Fcomplex csinhf(_Fcomplex) _NO_THROW;
_Fcomplex csqrtf(_Fcomplex) _NO_THROW;
_Fcomplex ctanf(_Fcomplex) _NO_THROW;
_Fcomplex ctanhf(_Fcomplex) _NO_THROW;
float normf(_Fcomplex) _NO_THROW;	/* added with TR1 */

long double cabsl(_Lcomplex) _NO_THROW;
_Lcomplex cacosl(_Lcomplex) _NO_THROW;
_Lcomplex cacoshl(_Lcomplex) _NO_THROW;
long double cargl(_Lcomplex) _NO_THROW;
_Lcomplex casinl(_Lcomplex) _NO_THROW;
_Lcomplex casinhl(_Lcomplex) _NO_THROW;
_Lcomplex catanl(_Lcomplex) _NO_THROW;
_Lcomplex catanhl(_Lcomplex) _NO_THROW;
_Lcomplex ccosl(_Lcomplex) _NO_THROW;
_Lcomplex ccoshl(_Lcomplex) _NO_THROW;
_Lcomplex cexpl(_Lcomplex) _NO_THROW;
/* long double cimagl(_Lcomplex) _NO_THROW; */
_Lcomplex clogl(_Lcomplex) _NO_THROW;
_Lcomplex clog10l(_Lcomplex) _NO_THROW;
_Lcomplex conjl(_Lcomplex) _NO_THROW;
_Lcomplex cpowl(_Lcomplex, _Lcomplex) _NO_THROW;
_Lcomplex cprojl(_Lcomplex) _NO_THROW;
/* long double creall(_Lcomplex) _NO_THROW; */
_Lcomplex csinl(_Lcomplex) _NO_THROW;
_Lcomplex csinhl(_Lcomplex) _NO_THROW;
_Lcomplex csqrtl(_Lcomplex) _NO_THROW;
_Lcomplex ctanl(_Lcomplex) _NO_THROW;
_Lcomplex ctanhl(_Lcomplex) _NO_THROW;
long double norml(_Lcomplex) _NO_THROW;	/* added with TR1 */

_Dcomplex (_Cbuild)(double, double) _NO_THROW;
_Dcomplex (_Cmulcc)(_Dcomplex, _Dcomplex) _NO_THROW;
_Dcomplex (_Cmulcr)(_Dcomplex, double) _NO_THROW;
_Dcomplex (_Cdivcc)(_Dcomplex, _Dcomplex) _NO_THROW;
_Dcomplex (_Cdivcr)(_Dcomplex, double) _NO_THROW;
_Dcomplex (_Caddcc)(_Dcomplex, _Dcomplex) _NO_THROW;
_Dcomplex (_Caddcr)(_Dcomplex, double) _NO_THROW;
_Dcomplex (_Csubcc)(_Dcomplex, _Dcomplex) _NO_THROW;
_Dcomplex (_Csubcr)(_Dcomplex, double) _NO_THROW;

_Fcomplex (_FCbuild)(float, float) _NO_THROW;
_Fcomplex (_FCmulcc)(_Fcomplex, _Fcomplex) _NO_THROW;
_Fcomplex (_FCmulcr)(_Fcomplex, float) _NO_THROW;
_Fcomplex (_FCdivcc)(_Fcomplex, _Fcomplex) _NO_THROW;
_Fcomplex (_FCdivcr)(_Fcomplex, float) _NO_THROW;
_Fcomplex (_FCaddcc)(_Fcomplex, _Fcomplex) _NO_THROW;
_Fcomplex (_FCaddcr)(_Fcomplex, float) _NO_THROW;
_Fcomplex (_FCsubcc)(_Fcomplex, _Fcomplex) _NO_THROW;
_Fcomplex (_FCsubcr)(_Fcomplex, float) _NO_THROW;

_Lcomplex (_LCbuild)(long double, long double) _NO_THROW;
_Lcomplex (_LCmulcc)(_Lcomplex, _Lcomplex) _NO_THROW;
_Lcomplex (_LCmulcr)(_Lcomplex, long double) _NO_THROW;
_Lcomplex (_LCdivcc)(_Lcomplex, _Lcomplex) _NO_THROW;
_Lcomplex (_LCdivcr)(_Lcomplex, long double) _NO_THROW;
_Lcomplex (_LCaddcc)(_Lcomplex, _Lcomplex) _NO_THROW;
_Lcomplex (_LCaddcr)(_Lcomplex, long double) _NO_THROW;
_Lcomplex (_LCsubcc)(_Lcomplex, _Lcomplex) _NO_THROW;
_Lcomplex (_LCsubcr)(_Lcomplex, long double) _NO_THROW;
_END_C_LIB_DECL
...
_C_LIB_DECL
_CSTD _Dcomplex clog(_CSTD _Dcomplex) _NO_THROW;
_END_C_LIB_DECL
}	// namespace _Dinkum_clog
