...
protected:
  ...
  void getCmdLineReservedRegs(const MachineFunction &MF, BitVector* Reserved) const;
public:
...
// Get the weight in units of pressure for this register class.
  ...
  /// shouldRotateRegisters - Returns true if the register allocator should
  /// rotate registers in the register class during allocation.
  virtual bool shouldRotateRegisters(const TargetRegisterClass *RC) const {
    return false;
  }
};
