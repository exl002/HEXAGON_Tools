...
public:
  ...
  bool getDiagnosticsInGroup(StringRef Group,
                             ...
                             llvm::SmallVectorImpl<StringRef> &SubGroups) const;
  ...
  static const WarningOption *FindOrAddUserWarningOption(
    StringRef Name,
    enum SubGroupAction Action,
    const SmallVectorImpl<StringRef> *SubGroups,
    SmallVectorImpl<StringRef> *UnknownSubGroups);
