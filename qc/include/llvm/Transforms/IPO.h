...
ModulePass *createGlobalOptimizerNoSRAPass();
...
Pass *createFunctionInliningPass(int Threshold, int OptLevel = 0);
...
//===----------------------------------------------------------------------===//
/// Reduce code size by wrapping repetitive code to pass constant arguments into
/// a common function
ModulePass *createShrinkWrapCommonArgsPass();

//===----------------------------------------------------------------------===//
/// Diff/Merge Instructions, BasicBlocks, ...
ModulePass *createDiffAndMergePass();

//===----------------------------------------------------------------------===//
/// ...
ModulePass *createCollocateConstantsPass();
