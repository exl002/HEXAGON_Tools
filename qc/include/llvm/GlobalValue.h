...
public:
  ...
  bool hasElemLabels() const { return !ElemLabels.empty(); }
  const std::string &getElemLabels() const { return ElemLabels; }
  void setElemLabels(StringRef EL) { ElemLabels = EL; }
