...
namespace llvm {
  ...
  /// Used for ScevgepMap comparison.
  struct ScevgepMapCompare {
  ...
  class SCEVExpander : public SCEVVisitor<SCEVExpander, Value*> {
    ...
    // These two maps hold generated GEP values in order to reuse.
    std::map<std::pair<Value*, Value*>, Value*> AddtogepMap;
    std::map<std::vector<Value*>, Value*, ScevgepMapCompare> ScevgepMap;
  ...
  private:
    ...
    void forgetInstruction(Value *I);
