...
/* NOTE: The input and expected results arrays have been shortened by
   1 so that they each contain 127 elements.  This is necessary to
   simulate the situation where the data length is not a multiple of
   the vector length. */
...
short int Input1[] __attribute__((aligned(8))) =
{
  ...
  0x23d8,0x5c10,0x3c59,0x78df,0x2b0d,0x379e,0x2c27,0x6aa7,0x5675,0x3db0,0x5b25,0x4f97,0x34fd,0x5643,0x2c6e
};
...
short int Input2[] __attribute__((aligned(8))) =
{
  ...
  0x45e6,0x0e7f,0x4bd8,0x39b7,0x6c80,0x0069,0x4c9b,0x1df0,0x3dd1,0x2708,0x175d,0x053b,0x5915,0x519e,0x17a1
};
...
short int Expected_results[] __attribute__((aligned(8))) =
{
  ...
  0x69be,0x6a8f,0x8831,0xb296,0x978d,0x3807,0x78c2,0x8897,0x9446,0x64b8,0x7282,0x54d2,0x8e12,0xa7e1,0x440f
};
...
REGISTER_VecADD_VERSION(VecADD_cleanup);
REGISTER_VecADD_VERSION(VecADD_separate);
...
struct VecADD_version funcs[] =
  {
    VecADD_VERSION(VecADD_orig, "Original code"), 
    VecADD_VERSION(VecADD_cleanup, "Vectorized cleanup loop"),
    VecADD_VERSION(VecADD_separate, "Vectorized with separation of concerns")
  };
