...
namespace llvm {
  ...
  protected:
    ...
    const char *Data128bitsDirective;        // Defaults to "\t.uleb128\t"
    ...
    /// CodeAlignDirective - If specified, a separate directive to align the
    /// instructions.
    const char *CodeAlignDirective;          // defaults to NULL.

    /// LoopAlignDirective - If specified, a separate directive to align the
    /// instructions.
    const char *LoopAlignDirective;          // defaults to NULL.

    /// FunctionAlignDirective - If specified, a separate directive to
    /// the beginning of the function's align instructions.
    const char *FunctionAlignDirective; // defaults to NULL.
  ...
  public:
    ...
    const char *getData128bitsDirective(unsigned AS = 0) const {
      return AS == 0 ? Data128bitsDirective : getDataASDirective(128, AS);
    }
    ...
    const char *getCodeAlignDirective() const {
      return CodeAlignDirective;
    }
    const char *getLoopAlignDirective() const {
      return LoopAlignDirective;
    }
    const char *getFunctionAlignDirective() const {
      return FunctionAlignDirective;
    }
