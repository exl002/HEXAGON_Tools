...
public:
  ...
  AnalysisUsage &addRequiredTransitiveID(const void *ID);
...
AnalysisType *Pass::getAnalysisIfAvailable() const {
  return getAnalysisIfAvailableID<AnalysisType>(&AnalysisType::ID);
}

template<typename AnalysisType>
AnalysisType *Pass::getAnalysisIfAvailableID(AnalysisID PI) const {
