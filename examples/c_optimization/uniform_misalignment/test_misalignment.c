...
REGISTER_VecADD_VERSION(VecADD_peel);
REGISTER_VecADD_VERSION(VecADD_misaligned);
...
struct VecADD_version funcs[] =
  {
    ...
    VecADD_VERSION(VecADD_peel, "Original code with peeling"), 
    VecADD_VERSION(VecADD_misaligned, "Vectorized code with peeling") 
  };
...
main()
{
  ...
  for (index = 0 ; index < FUNC_COUNT ; index++) {
    ...
    funcs[index].function(Input1+1, Input2+1, Output+1, OUTPUT_SIZE-1);
