...
result_scale_t dsplib_approx_invert_simple(Word32 x);
...
result_scale_t dsplib_newtons_invert(Word32 x);
...
extern result_scale_t approx_uinv_linlut8(UWord32 input);
...
extern result_scale_t approx_uinv_cubelut8(UWord32 input);
...
extern result_scale_t approx_uinv_newt(UWord32 input, UWord32 iter);
...
extern result_scale_t approx_uinv_tylr(UWord32 input, UWord32 hi_pow);
...
extern result_scale_t approx_dB_to_ulin_linlut8( Word32 input );
...
extern result_scale_t approx_dB_to_ulin_cubefit( Word32 input );
...
extern result_scale_t approx_dB_to_ulin_quadlut8( Word32 input );
