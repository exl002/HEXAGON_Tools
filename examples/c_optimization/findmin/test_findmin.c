...
REGISTER_findmin_VERSION(findmin_mux);
REGISTER_findmin_VERSION(findmin_ternary);
...
struct findmin_version funcs[] =
  {
    ...
    findmin_VERSION(findmin_mux, "Mux intrinsic"),
    findmin_VERSION(findmin_ternary, "Ternary operators")
  };
