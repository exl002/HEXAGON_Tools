...
public:
  ...
  /// Reclaim "uninteresting" nodes created since the last time this method was
  /// called. If 'InUse' is specified, it contains nodes that may seem
  /// "uninteresting" but should be not be reclaimed.
  typedef llvm::SmallPtrSet<const ExplodedNode*,8> InUseSet;
  void reclaimRecentlyAllocatedNodes(InUseSet *InUse);
