...
namespace llvm {
  ...
  public:
    ...
    /// EmitFunctionEntryAlignment - Emit a customizable alignment directive.
    /// Defaults to calling EmitAlignment.
    ///
    virtual void EmitFunctionAlignment(unsigned NumBytes,
