...
public:
  ...
  /// Toolchain provides an LTO tool (i.e. its ok to call SelectTool for a
  /// JobAction of kind Action::LinkTimeOptimizeJobClass)
  virtual bool SupportsLinkTimeOptimizeJobClass() const;
};
