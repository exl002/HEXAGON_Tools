...
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mfalign_all;
#define x_VAR_mfalign_all do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mfalign_labels;
#define x_VAR_mfalign_labels do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mfalign_loops;
#define x_VAR_mfalign_loops do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mno_falign;
#define x_VAR_mno_falign do_not_use
#endif
#ifndef GENERATOR_FILE
  const char *x_VAR_moslib_;
#define x_VAR_moslib_ do_not_use
#endif
#ifndef GENERATOR_FILE
...
#define MASK_AGGREGATE_ACCESS (1 << 0)
#define MASK_ANNOTATE_DUPLEX (1 << 1)
#define MASK_BASE_PLUS_INDEX (1 << 2)
#define MASK_DEALLOC_RETURN (1 << 3)
#define MASK_DEEP_PHI_MATCH (1 << 4)
#define MASK_DUPLEX_SCHEDULING (1 << 5)
#define MASK_ENABLE_SUBREG1 (1 << 6)
#define MASK_EXTENDED_CROSSJUMPING (1 << 7)
#define MASK_HARDWARE_LOOPS (1 << 8)
#define MASK_IEEE_RND_NEAR (1 << 9)
#define MASK_LITERAL_INTRINSICS (1 << 10)
#define MASK_LITERAL_POOL (1 << 11)
#define MASK_LITERAL_POOL_ADDRESSES (1 << 12)
#define MASK_LOCAL_COMBINE (1 << 13)
#define MASK_LOCAL_COMBINE_IMMEDIATE (1 << 14)
#define MASK_LONG_CALLS (1 << 15)
#define MASK_MEMOPS (1 << 16)
#define MASK_MOD_HW_LOOPS (1 << 17)
#define MASK_NEW_PREDICATES (1 << 18)
#define MASK_NEW_VALUE_JUMP (1 << 19)
#define MASK_NEW_VALUE_STORES (1 << 20)
#define MASK_PACKETS (1 << 21)
#define MASK_PULLUP (1 << 22)
#define MASK_QDSP6_COMPAT (1 << 23)
#define MASK_RESOLVE_RESTRICT_ALIASING (1 << 24)
#define MASK_SAVE_RESTORE_R25 (1 << 25)
#define MASK_SECTION_SORTING (1 << 26)
#define MASK_SECTION_SORTING_CODE_SUPPORT (1 << 27)
#define MASK_USE_COMMON_PROLOGUE_EPILOGUE_FUNCTIONS (1 << 28)
#define MASK_UNCACHED_DATA (1 << 29)

#define TARGET_AGGREGATE_ACCESS ((target_flags & MASK_AGGREGATE_ACCESS) != 0)
#define TARGET_ANNOTATE_DUPLEX ((target_flags & MASK_ANNOTATE_DUPLEX) != 0)
#define TARGET_BASE_PLUS_INDEX ((target_flags & MASK_BASE_PLUS_INDEX) != 0)
#define TARGET_DEALLOC_RETURN ((target_flags & MASK_DEALLOC_RETURN) != 0)
#define TARGET_DEEP_PHI_MATCH ((target_flags & MASK_DEEP_PHI_MATCH) != 0)
#define TARGET_DUPLEX_SCHEDULING ((target_flags & MASK_DUPLEX_SCHEDULING) != 0)
#define TARGET_ENABLE_SUBREG1 ((target_flags & MASK_ENABLE_SUBREG1) != 0)
#define TARGET_EXTENDED_CROSSJUMPING ((target_flags & MASK_EXTENDED_CROSSJUMPING) != 0)
#define TARGET_HARDWARE_LOOPS ((target_flags & MASK_HARDWARE_LOOPS) != 0)
#define TARGET_IEEE_RND_NEAR ((target_flags & MASK_IEEE_RND_NEAR) != 0)
#define TARGET_LITERAL_INTRINSICS ((target_flags & MASK_LITERAL_INTRINSICS) != 0)
#define TARGET_LITERAL_POOL ((target_flags & MASK_LITERAL_POOL) != 0)
#define TARGET_LITERAL_POOL_ADDRESSES ((target_flags & MASK_LITERAL_POOL_ADDRESSES) != 0)
#define TARGET_LOCAL_COMBINE ((target_flags & MASK_LOCAL_COMBINE) != 0)
#define TARGET_LOCAL_COMBINE_IMMEDIATE ((target_flags & MASK_LOCAL_COMBINE_IMMEDIATE) != 0)
#define TARGET_LONG_CALLS ((target_flags & MASK_LONG_CALLS) != 0)
#define TARGET_MEMOPS ((target_flags & MASK_MEMOPS) != 0)
#define TARGET_MOD_HW_LOOPS ((target_flags & MASK_MOD_HW_LOOPS) != 0)
#define TARGET_NEW_PREDICATES ((target_flags & MASK_NEW_PREDICATES) != 0)
#define TARGET_NEW_VALUE_JUMP ((target_flags & MASK_NEW_VALUE_JUMP) != 0)
#define TARGET_NEW_VALUE_STORES ((target_flags & MASK_NEW_VALUE_STORES) != 0)
#define TARGET_PACKETS ((target_flags & MASK_PACKETS) != 0)
#define TARGET_PULLUP ((target_flags & MASK_PULLUP) != 0)
#define TARGET_QDSP6_COMPAT ((target_flags & MASK_QDSP6_COMPAT) != 0)
#define TARGET_RESOLVE_RESTRICT_ALIASING ((target_flags & MASK_RESOLVE_RESTRICT_ALIASING) != 0)
#define TARGET_SAVE_RESTORE_R25 ((target_flags & MASK_SAVE_RESTORE_R25) != 0)
...
#define TARGET_USE_COMMON_PROLOGUE_EPILOGUE_FUNCTIONS ((target_flags & MASK_USE_COMMON_PROLOGUE_EPILOGUE_FUNCTIONS) != 0)
...
enum opt_code
{
  ...
  OPT_Wpoison_system_directories = 296,      /* -Wpoison-system-directories */
  ...
  OPT_falign_arrays = 410,                   /* -falign-arrays */
  ...
  OPT_fextension_elimination = 543,          /* -fextension-elimination */
  OPT_fexternal_blas = 544,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 545, */       /* -fexternal-templates */
  OPT_ff2c = 546,                            /* -ff2c */
  OPT_ffast_math = 547,                      /* -ffast-math */
  OPT_ffeature_proxy = 548,                  /* -ffeature-proxy */
  OPT_ffilelist_file = 549,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 550,               /* -ffinite-math-only */
  OPT_ffixed_ = 551,                         /* -ffixed- */
  OPT_ffixed_form = 552,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 553,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 554,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 555,                    /* -ffloat-store */
  OPT_ffor_scope = 556,                      /* -ffor-scope */
  /* OPT_fforce_addr = 557, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 558,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 559,              /* -fforward-propagate */
  OPT_ffp_contract_ = 560,                   /* -ffp-contract= */
  OPT_ffpe_trap_ = 561,                      /* -ffpe-trap= */
  OPT_ffree_form = 562,                      /* -ffree-form */
  OPT_ffree_line_length_ = 563,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 564,          /* -ffree-line-length-none */
  OPT_ffreestanding = 565,                   /* -ffreestanding */
  OPT_ffriend_injection = 566,               /* -ffriend-injection */
  OPT_ffunction_cse = 567,                   /* -ffunction-cse */
  OPT_ffunction_sections = 568,              /* -ffunction-sections */
  OPT_fgcse = 569,                           /* -fgcse */
  OPT_fgcse_after_reload = 570,              /* -fgcse-after-reload */
  OPT_fgcse_las = 571,                       /* -fgcse-las */
  OPT_fgcse_lm = 572,                        /* -fgcse-lm */
  OPT_fgcse_sm = 573,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 574,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 575,                    /* -fgnu-runtime */
  OPT_fgnu89_inline = 576,                   /* -fgnu89-inline */
  OPT_fgo_dump_ = 577,                       /* -fgo-dump- */
  OPT_fgo_prefix_ = 578,                     /* -fgo-prefix= */
  OPT_fgraphite = 579,                       /* -fgraphite */
  OPT_fgraphite_identity = 580,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 581,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 582, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 583, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 584,           /* -fhash-synchronization */
  /* OPT_fhelp = 585, */                     /* -fhelp */
  /* OPT_fhelp_ = 586, */                    /* -fhelp= */
  /* OPT_fhonor_std = 587, */                /* -fhonor-std */
  OPT_fhosted = 588,                         /* -fhosted */
  /* OPT_fhuge_objects = 589, */             /* -fhuge-objects */
  OPT_fident = 590,                          /* -fident */
  OPT_fif_conversion = 591,                  /* -fif-conversion */
  OPT_fif_conversion2 = 592,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 593,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 594,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 595,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 596,             /* -fimplicit-templates */
  OPT_findirect_classes = 597,               /* -findirect-classes */
  OPT_findirect_dispatch = 598,              /* -findirect-dispatch */
  OPT_findirect_inlining = 599,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 600,         /* -finhibit-size-directive */
  OPT_finit_character_ = 601,                /* -finit-character= */
  OPT_finit_integer_ = 602,                  /* -finit-integer= */
  OPT_finit_local_zero = 603,                /* -finit-local-zero */
  OPT_finit_logical_ = 604,                  /* -finit-logical= */
  OPT_finit_real_ = 605,                     /* -finit-real= */
  OPT_finline = 606,                         /* -finline */
  OPT_finline_functions = 607,               /* -finline-functions */
  OPT_finline_functions_called_once = 608,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 609, */            /* -finline-limit- */
  OPT_finline_limit_ = 610,                  /* -finline-limit= */
  OPT_finline_small_functions = 611,         /* -finline-small-functions */
  OPT_finput_charset_ = 612,                 /* -finput-charset= */
  OPT_finstrument_function_calls = 613,      /* -finstrument-function-calls */
  OPT_finstrument_functions = 614,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 615,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 616,/* -finstrument-functions-exclude-function-list= */
  OPT_fintrinsic_modules_path = 617,         /* -fintrinsic-modules-path */
  OPT_fipa_cp = 618,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 619,                   /* -fipa-cp-clone */
  OPT_fipa_matrix_reorg = 620,               /* -fipa-matrix-reorg */
  OPT_fipa_profile = 621,                    /* -fipa-profile */
  OPT_fipa_pta = 622,                        /* -fipa-pta */
  OPT_fipa_pure_const = 623,                 /* -fipa-pure-const */
  OPT_fipa_reference = 624,                  /* -fipa-reference */
  OPT_fipa_sra = 625,                        /* -fipa-sra */
  OPT_fipa_struct_reorg = 626,               /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 627,                 /* -fira-algorithm= */
  OPT_fira_loop_pressure = 628,              /* -fira-loop-pressure */
  OPT_fira_region_ = 629,                    /* -fira-region= */
  OPT_fira_share_save_slots = 630,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 631,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 632,                   /* -fira-verbose= */
  OPT_fivopts = 633,                         /* -fivopts */
  OPT_fjni = 634,                            /* -fjni */
  OPT_fjump_tables = 635,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 636,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 637,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 638,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 639, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 640,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 641,             /* -fleading-underscore */
  OPT_flicense_me = 642,                     /* -flicense-me */
  OPT_floop_block = 643,                     /* -floop-block */
  OPT_floop_flatten = 644,                   /* -floop-flatten */
  OPT_floop_interchange = 645,               /* -floop-interchange */
  /* OPT_floop_optimize = 646, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 647,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 648,                /* -floop-strip-mine */
  OPT_flto = 649,                            /* -flto */
  OPT_flto_compression_level_ = 650,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 651,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 652,         /* -flto-partition=balanced */
  OPT_flto_partition_none = 653,             /* -flto-partition=none */
  OPT_flto_report = 654,                     /* -flto-report */
  OPT_flto_ = 655,                           /* -flto= */
  OPT_fltrans = 656,                         /* -fltrans */
  OPT_fltrans_output_list_ = 657,            /* -fltrans-output-list= */
  OPT_fmain_ = 658,                          /* -fmain= */
  OPT_fmath_errno = 659,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 660,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 661,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 662,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 663,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 664,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 665,                     /* -fmem-report */
  OPT_fmerge_all_constants = 666,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 667,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 668,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 669,                /* -fmessage-length= */
  OPT_fmodule_private = 670,                 /* -fmodule-private */
  OPT_fmodulo_sched = 671,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 672,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 673,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 674,                  /* -fms-extensions */
  OPT_fmudflap = 675,                        /* -fmudflap */
  OPT_fmudflapir = 676,                      /* -fmudflapir */
  OPT_fmudflapth = 677,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 678, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 679, */                  /* -fnew-abi */
  OPT_fnext_runtime = 680,                   /* -fnext-runtime */
  OPT_fnil_receivers = 681,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 682,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 683,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 684, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 685,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 686,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 687,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 688,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 689,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 690,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 691,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 692,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 693,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 694,             /* -fomit-frame-pointer */
  OPT_fopenmp = 695,                         /* -fopenmp */
  OPT_foperator_names = 696,                 /* -foperator-names */
  OPT_foptimize_register_move = 697,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 698,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 699,/* -foptimize-static-class-initialization */
  /* OPT_foptional_diags = 700, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 701,              /* -foutput-class-dir= */
  OPT_fpack_derived = 702,                   /* -fpack-derived */
  OPT_fpack_struct = 703,                    /* -fpack-struct */
  OPT_fpack_struct_ = 704,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 705,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 706,              /* -fpcc-struct-return */
  OPT_fpch_deps = 707,                       /* -fpch-deps */
  OPT_fpch_preprocess = 708,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 709,                     /* -fpeel-loops */
  OPT_fpeephole = 710,                       /* -fpeephole */
  OPT_fpeephole2 = 711,                      /* -fpeephole2 */
  OPT_fpermissive = 712,                     /* -fpermissive */
  OPT_fpic = 713,                            /* -fpic */
  OPT_fpie = 714,                            /* -fpie */
  OPT_fplan9_extensions = 715,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 716,                    /* -fplugin-arg- */
  OPT_fplugin_ = 717,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 718,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 719,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 720,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 721,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 722,                   /* -fpreprocessed */
  OPT_fpretty_templates = 723,               /* -fpretty-templates */
  OPT_fprofile = 724,                        /* -fprofile */
  OPT_fprofile_arcs = 725,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 726,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 727,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 728,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 729,              /* -fprofile-generate= */
  OPT_fprofile_use = 730,                    /* -fprofile-use */
  OPT_fprofile_use_ = 731,                   /* -fprofile-use= */
  OPT_fprofile_values = 732,                 /* -fprofile-values */
  OPT_fpromote_loop_indices = 733,           /* -fpromote-loop-indices */
  ...
  OPT_fremove_local_statics = 747,           /* -fremove-local-statics */
  ...
  OPT_fshrink_wrap = 795,                    /* -fshrink-wrap */
  ...
  OPT_ftree_if_to_switch_conversion = 852,   /* -ftree-if-to-switch-conversion */
  OPT_ftree_loop_distribute_patterns = 853,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 854,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 855,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 856,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 857,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 858,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 859, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 860,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 861,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 862,        /* -ftree-parallelize-loops= */
  OPT_ftree_phiprop = 863,                   /* -ftree-phiprop */
  OPT_ftree_pre = 864,                       /* -ftree-pre */
  OPT_ftree_pre_partial_partial = 865,       /* -ftree-pre-partial-partial */
  OPT_ftree_pre_partial_partial_obliviously = 866,/* -ftree-pre-partial-partial-obliviously */
  OPT_ftree_pta = 867,                       /* -ftree-pta */
  OPT_ftree_reassoc = 868,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 869, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 870,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 871,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 872,             /* -ftree-slp-vectorize */
  OPT_ftree_sra = 873,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 874, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 875, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 876,         /* -ftree-switch-conversion */
  OPT_ftree_ter = 877,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 878,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 879,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 880,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 881,                       /* -ftree-vrp */
  OPT_funderscoring = 882,                   /* -funderscoring */
  OPT_funit_at_a_time = 883,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 884,               /* -funroll-all-loops */
  OPT_funroll_loops = 885,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 886,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 887,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 888,             /* -funsigned-bitfields */
  OPT_funsigned_char = 889,                  /* -funsigned-char */
  OPT_funswitch_loops = 890,                 /* -funswitch-loops */
  OPT_funwind_tables = 891,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 892,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 893,                   /* -fuse-boehm-gc */
  OPT_fuse_caller_save = 894,                /* -fuse-caller-save */
  OPT_fuse_cxa_atexit = 895,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 896,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 897,          /* -fuse-divide-subroutine */
  OPT_fuse_linker_plugin = 898,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 899,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 900,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 901,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 902,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 903, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 904,                /* -fvect-cost-model */
  OPT_fverbose_asm = 905,                    /* -fverbose-asm */
  /* OPT_fversion = 906, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 907,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 908,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 909,                    /* -fvisibility= */
  OPT_fvpt = 910,                            /* -fvpt */
  /* OPT_fvtable_gc = 911, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 912, */            /* -fvtable-thunks */
  OPT_fweak = 913,                           /* -fweak */
  OPT_fweb = 914,                            /* -fweb */
  OPT_fwhole_file = 915,                     /* -fwhole-file */
  OPT_fwhole_program = 916,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 917,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 918,              /* -fworking-directory */
  OPT_fwpa = 919,                            /* -fwpa */
  OPT_fwrapv = 920,                          /* -fwrapv */
  /* OPT_fxref = 921, */                     /* -fxref */
  OPT_fzee = 922,                            /* -fzee */
  OPT_fzero_initialized_in_bss = 923,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 924,                      /* -fzero-link */
  OPT_g = 925,                               /* -g */
  OPT_gant = 926,                            /* -gant */
  OPT_gcoff = 927,                           /* -gcoff */
  OPT_gdwarf_ = 928,                         /* -gdwarf- */
  OPT_gen_decls = 929,                       /* -gen-decls */
  OPT_ggdb = 930,                            /* -ggdb */
  OPT_gnat = 931,                            /* -gnat */
  OPT_gnatO = 932,                           /* -gnatO */
  OPT_gno_strict_dwarf = 933,                /* -gno-strict-dwarf */
  OPT_gstabs = 934,                          /* -gstabs */
  OPT_gstabs_ = 935,                         /* -gstabs+ */
  OPT_gstrict_dwarf = 936,                   /* -gstrict-dwarf */
  OPT_gtoggle = 937,                         /* -gtoggle */
  OPT_gvms = 938,                            /* -gvms */
  OPT_gxcoff = 939,                          /* -gxcoff */
  OPT_gxcoff_ = 940,                         /* -gxcoff+ */
  OPT_h = 941,                               /* -h */
  OPT_idirafter = 942,                       /* -idirafter */
  OPT_imacros = 943,                         /* -imacros */
  OPT_imultilib = 944,                       /* -imultilib */
  OPT_include = 945,                         /* -include */
  OPT_iplugindir_ = 946,                     /* -iplugindir= */
  OPT_iprefix = 947,                         /* -iprefix */
  OPT_iquote = 948,                          /* -iquote */
  OPT_isysroot = 949,                        /* -isysroot */
  OPT_isystem = 950,                         /* -isystem */
  OPT_iwithprefix = 951,                     /* -iwithprefix */
  OPT_iwithprefixbefore = 952,               /* -iwithprefixbefore */
  OPT_k8 = 953,                              /* -k8 */
  OPT_l = 954,                               /* -l */
  OPT_lang_asm = 955,                        /* -lang-asm */
  OPT_mabi_ = 956,                           /* -mabi= */
  OPT_maggregate_access = 957,               /* -maggregate-access */
  OPT_mannotate_duplex = 958,                /* -mannotate_duplex */
  OPT_march_ = 959,                          /* -march= */
  OPT_mbase_plus_index = 960,                /* -mbase-plus-index */
  OPT_mcpu_ = 961,                           /* -mcpu= */
  OPT_mdealloc_return = 962,                 /* -mdealloc_return */
  OPT_mdeep_phi_match = 963,                 /* -mdeep-phi-match */
  OPT_mduplex_scheduling = 964,              /* -mduplex-scheduling */
  OPT_menable_subreg1 = 965,                 /* -menable-subreg1 */
  OPT_mextended_crossjumping = 966,          /* -mextended-crossjumping */
  OPT_mfalign_all = 967,                     /* -mfalign-all */
  OPT_mfalign_labels = 968,                  /* -mfalign-labels */
  OPT_mfalign_loops = 969,                   /* -mfalign-loops */
  OPT_mhardware_loops = 970,                 /* -mhardware-loops */
  OPT_mieee_rnd_near = 971,                  /* -mieee-rnd-near */
  OPT_mliteral_intrinsics = 972,             /* -mliteral-intrinsics */
  OPT_mliteral_pool = 973,                   /* -mliteral-pool */
  OPT_mliteral_pool_addresses = 974,         /* -mliteral-pool-addresses */
  OPT_mlocal_combine = 975,                  /* -mlocal-combine */
  OPT_mlocal_combine_immediate = 976,        /* -mlocal-combine-immediate */
  OPT_mlong_calls = 977,                     /* -mlong-calls */
  OPT_mmemops = 978,                         /* -mmemops */
  OPT_mmod_hw_loops = 979,                   /* -mmod_hw_loops */
  OPT_mnew_predicates = 980,                 /* -mnew-predicates */
  OPT_mnew_value_jump = 981,                 /* -mnew-value-jump */
  OPT_mnew_value_stores = 982,               /* -mnew-value-stores */
  OPT_mno_falign = 983,                      /* -mno-falign */
  OPT_moslib_ = 984,                         /* -moslib= */
  OPT_mpackets = 985,                        /* -mpackets */
  OPT_mpullup = 986,                         /* -mpullup */
  OPT_mqdsp6_compat = 987,                   /* -mqdsp6-compat */
  OPT_mresolve_restrict_aliasing = 988,      /* -mresolve-restrict-aliasing */
  OPT_msave_restore_r25 = 989,               /* -msave-restore-r25 */
  OPT_msort_sda = 990,                       /* -msort-sda */
  OPT_msort_sda_code_support = 991,          /* -msort-sda-code-support */
  OPT_muse_common_prologue_epilogue_functions = 992,/* -muse-common-prologue-epilogue-functions */
  OPT_mv1_v2_uncached_data = 993,            /* -mv1-v2-uncached-data */
  /* OPT_mv4 = 994, */                       /* -mv4 */
  /* OPT_mv5 = 995, */                       /* -mv5 */
  /* OPT_mv55 = 996, */                      /* -mv55 */
  OPT_n = 997,                               /* -n */
  ...
  OPT_pie = 1012,                            /* -pie */
  OPT_pipe = 1013,                           /* -pipe */
  OPT_print_file_name_ = 1014,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1015,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1016,          /* -print-multi-directory */
  OPT_print_multi_lib = 1017,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1018,       /* -print-multi-os-directory */
  OPT_print_objc_runtime_info = 1019,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1020,               /* -print-prog-name= */
  OPT_print_search_dirs = 1021,              /* -print-search-dirs */
  OPT_print_sysroot = 1022,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1023,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1024,                          /* -quiet */
  OPT_r = 1025,                              /* -r */
  OPT_remap = 1026,                          /* -remap */
  OPT_s = 1027,                              /* -s */
  OPT_s_bc_abi = 1028,                       /* -s-bc-abi */
  OPT_save_temps = 1029,                     /* -save-temps */
  OPT_save_temps_ = 1030,                    /* -save-temps= */
  OPT_shared = 1031,                         /* -shared */
  OPT_shared_libgcc = 1032,                  /* -shared-libgcc */
  /* OPT_specs = 1033, */                    /* -specs */
  OPT_specs_ = 1034,                         /* -specs= */
  OPT_static = 1035,                         /* -static */
  OPT_static_libgcc = 1036,                  /* -static-libgcc */
  OPT_static_libgcj = 1037,                  /* -static-libgcj */
  OPT_static_libgfortran = 1038,             /* -static-libgfortran */
  OPT_static_libgo = 1039,                   /* -static-libgo */
  OPT_static_libstdc__ = 1040,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1041, */                /* -std=c++03 */
  OPT_std_c__0x = 1042,                      /* -std=c++0x */
  OPT_std_c__98 = 1043,                      /* -std=c++98 */
  OPT_std_c1x = 1044,                        /* -std=c1x */
  /* OPT_std_c89 = 1045, */                  /* -std=c89 */
  OPT_std_c90 = 1046,                        /* -std=c90 */
  OPT_std_c99 = 1047,                        /* -std=c99 */
  /* OPT_std_c9x = 1048, */                  /* -std=c9x */
  OPT_std_f2003 = 1049,                      /* -std=f2003 */
  OPT_std_f2008 = 1050,                      /* -std=f2008 */
  OPT_std_f95 = 1051,                        /* -std=f95 */
  OPT_std_gnu = 1052,                        /* -std=gnu */
  OPT_std_gnu__0x = 1053,                    /* -std=gnu++0x */
  OPT_std_gnu__98 = 1054,                    /* -std=gnu++98 */
  OPT_std_gnu1x = 1055,                      /* -std=gnu1x */
  /* OPT_std_gnu89 = 1056, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1057,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1058,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1059, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1060, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1061,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1062, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1063, */         /* -std=iso9899:199x */
  OPT_std_legacy = 1064,                     /* -std=legacy */
  OPT_symbolic = 1065,                       /* -symbolic */
  OPT_t = 1066,                              /* -t */
  OPT_time = 1067,                           /* -time */
  OPT_time_ = 1068,                          /* -time= */
  OPT_traditional = 1069,                    /* -traditional */
  OPT_traditional_cpp = 1070,                /* -traditional-cpp */
  OPT_trigraphs = 1071,                      /* -trigraphs */
  OPT_u = 1072,                              /* -u */
  OPT_undef = 1073,                          /* -undef */
  OPT_v = 1074,                              /* -v */
  OPT_version = 1075,                        /* -version */
  OPT_w = 1076,                              /* -w */
  OPT_wrapper = 1077,                        /* -wrapper */
  OPT_x = 1078,                              /* -x */
  OPT_z = 1079,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
