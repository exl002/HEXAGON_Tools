...
extern unsigned VectorRegisterSize;

/// Returns for the target architecture the size of a vector register in bytes.
static inline int getVectorRegisterSize(void) {
  return polly::VectorRegisterSize;
}
