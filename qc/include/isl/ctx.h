...
__isl_export void isl_handle_error(isl_ctx *ctx, enum isl_error error, const char *msg,
...
__isl_export struct isl_options *isl_ctx_options(isl_ctx *ctx);

__isl_export isl_ctx *isl_ctx_alloc_with_options(struct isl_args *args,
	__isl_take void *opt);
__isl_export isl_ctx *isl_ctx_alloc(void);
__isl_export void *isl_ctx_peek_options(isl_ctx *ctx, struct isl_args *args);
__isl_export int isl_ctx_parse_options(isl_ctx *ctx, int argc, char **argv, unsigned flags);
__isl_export void isl_ctx_ref(struct isl_ctx *ctx);
__isl_export void isl_ctx_deref(struct isl_ctx *ctx);
__isl_export void isl_ctx_free(isl_ctx *ctx);

__isl_export void isl_ctx_abort(isl_ctx *ctx);
__isl_export void isl_ctx_resume(isl_ctx *ctx);
__isl_export int isl_ctx_aborted(isl_ctx *ctx);
...
__isl_export enum isl_error isl_ctx_last_error(isl_ctx *ctx);
__isl_export void isl_ctx_reset_error(isl_ctx *ctx);
__isl_export void isl_ctx_set_error(isl_ctx *ctx, enum isl_error error);
