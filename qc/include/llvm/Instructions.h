...
public:
  ...
  /// \brief Return true if the call should not be inlined by default.
  bool isNoInlineByDefault() const {
    return hasFnAttr(Attributes::NoInlineByDefault);
  }
  void setIsNoInlineByDefault() {
    addAttribute(AttrListPtr::FunctionIndex,
                 Attributes::get(getContext(), Attributes::NoInlineByDefault));
  }
